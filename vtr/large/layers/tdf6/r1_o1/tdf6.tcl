...
open_project -reset tdf6_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf6.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf6.cpp"
set_top tdf6_top

# Set variables for the optimization directives
set top tdf6_top
set filter_top tdf6_top
set in_data in_data
...
source tdf6_impl_directives.tcl
source ../tdf6_conv_directives.tcl
