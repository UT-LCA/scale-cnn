...
open_project -reset tdf12_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf12.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf12.cpp"
set_top tdf12_top

# Set variables for the optimization directives
set top tdf12_top
set filter_top tdf12_top
set in_data in_data
...
source tdf12_impl_directives.tcl
source ../tdf12_conv_directives.tcl
