...
data_t tdf10_accum_4(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf10 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf10_accum_3(accum2_out_0, accum3_out_0);
      tdf10_accum_3(accum2_out_1, accum3_out_1);
      sums[0] = tdf10_accum_4(accum3_out_0);
      sums[1] = tdf10_accum_4(accum3_out_1);
