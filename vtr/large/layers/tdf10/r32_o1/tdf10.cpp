...
// It reduces 576 inputs to 9 outputs.
// The estimated latency is 64 cycles.
void tdf10_accum_1(
   data_t accum_in[576], 
   data_t accum_out[9]
) {
   ...
   IL_LOOP: for (uint16_t i1 = 0; i1 < 9; i1++) {
      ...
      data_t sum60 = sum56 + sum57;
      data_t sum61 = sum58 + sum59;
      data_t sum62 = sum60 + sum61;
      accum_out[out_idx+0] = sum62;
      out_idx += 1;
...
// The estimated latency is 46 cycles.
data_t tdf10_accum_3(data_t accum_in[5]) {
   data_t sum = 0.0;
