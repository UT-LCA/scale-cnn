...
data_t tdf2_accum_7(data_t accum_in[4]) {
...
void tdf2 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf2_accum_3(accum2_out_0, accum3_out_0);
      tdf2_accum_3(accum2_out_1, accum3_out_1);
      ...
      tdf2_accum_4(accum3_out_0, accum4_out_0);
      tdf2_accum_4(accum3_out_1, accum4_out_1);
      ...
      tdf2_accum_5(accum4_out_0, accum5_out_0);
      tdf2_accum_5(accum4_out_1, accum5_out_1);
      ...
      tdf2_accum_6(accum5_out_0, accum6_out_0);
      tdf2_accum_6(accum5_out_1, accum6_out_1);
      sums[0] = tdf2_accum_7(accum6_out_0);
      sums[1] = tdf2_accum_7(accum6_out_1);
