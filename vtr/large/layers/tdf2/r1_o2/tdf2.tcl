...
open_project -reset tdf2_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf2.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf2.cpp"
set_top tdf2_top

# Set variables for the optimization directives
set top tdf2_top
set filter_top tdf2_top
set in_data in_data
...
source tdf2_impl_directives.tcl
source ../tdf2_conv_directives.tcl
