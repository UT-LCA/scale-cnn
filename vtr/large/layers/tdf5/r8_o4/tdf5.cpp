...
data_t tdf5_accum_4(data_t accum_in[3]) {
...
void tdf5 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf5_accum_3(accum2_out_2, accum3_out_2);
      tdf5_accum_3(accum2_out_3, accum3_out_3);
      sums[0] = tdf5_accum_4(accum3_out_0);
      sums[1] = tdf5_accum_4(accum3_out_1);
      sums[2] = tdf5_accum_4(accum3_out_2);
      sums[3] = tdf5_accum_4(accum3_out_3);
