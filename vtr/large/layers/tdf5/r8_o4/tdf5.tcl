...
open_project -reset tdf5_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf5.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf5.cpp"
set_top tdf5_top

# Set variables for the optimization directives
set top tdf5_top
set filter_top tdf5_top
set in_data in_data
...
source tdf5_impl_directives.tcl
source ../tdf5_conv_directives.tcl
