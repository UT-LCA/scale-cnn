...
void tdf5_poolOutputs (
   ...
   if (storeOutput) {
      tdf5_writeOutputs_unaligned(i_out, j_out, k, max_vals, out_data);
   }
}
...
// It reduces 144 inputs to 80 outputs.
...
void tdf5_accum_1(
   ...
   IL_LOOP: for (uint16_t i1 = 0; i1 < 5; i1++) {
      ...
      accum_out[out_idx+0] = sum15;
      accum_out[out_idx+1] = sum14;
      accum_out[out_idx+2] = sum13;
      accum_out[out_idx+3] = sum12;
      accum_out[out_idx+4] = sum11;
      accum_out[out_idx+5] = sum10;
      accum_out[out_idx+6] = sum9;
      accum_out[out_idx+7] = sum8;
      accum_out[out_idx+8] = sum7;
      accum_out[out_idx+9] = sum6;
      accum_out[out_idx+10] = sum5;
      accum_out[out_idx+11] = sum4;
      accum_out[out_idx+12] = sum3;
      accum_out[out_idx+13] = sum2;
      accum_out[out_idx+14] = sum1;
      accum_out[out_idx+15] = sum0;
      out_idx += 16;
...
// This is a pipelined tree accumulation stage
// It reduces 80 inputs to 48 outputs.
...
// This is a pipelined tree accumulation stage
// It reduces 48 inputs to 32 outputs.
...
void tdf5_accum_3(
   ...
   IL_LOOP: for (uint16_t i1 = 0; i1 < 2; i1++) {
      ...
      WRPC_LOOP: for (uint16_t w = 0; w < 32; w++) {
         // Need this bounds check because input length is not necessarily
         // a multiple of words read per cycle.
         vals[w] = (i+w < 48) ? accum_in[i+w] : (data_t)0;
      }
      data_t sum0 = vals[31] + vals[30];
      data_t sum1 = vals[29] + vals[28];
      data_t sum2 = vals[27] + vals[26];
...
data_t tdf5_accum_7(data_t accum_in[4]) {
...
void tdf5 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_1[80];
      #pragma HLS array_partition variable=accum1_out_0 cyclic factor=16
      #pragma HLS array_partition variable=accum1_out_1 cyclic factor=16
      tdf5_accum_1(products[0], accum1_out_0);
      tdf5_accum_1(products[1], accum1_out_1);
      data_t accum2_out_0[48];
      data_t accum2_out_1[48];
      #pragma HLS array_partition variable=accum2_out_0 cyclic factor=16
      #pragma HLS array_partition variable=accum2_out_1 cyclic factor=16
      tdf5_accum_2(accum1_out_0, accum2_out_0);
      tdf5_accum_2(accum1_out_1, accum2_out_1);
      data_t accum3_out_0[32];
      data_t accum3_out_1[32];
      #pragma HLS array_partition variable=accum3_out_0 cyclic factor=16
      #pragma HLS array_partition variable=accum3_out_1 cyclic factor=16
      tdf5_accum_3(accum2_out_0, accum3_out_0);
      tdf5_accum_3(accum2_out_1, accum3_out_1);
      data_t accum4_out_0[16];
      data_t accum4_out_1[16];
      #pragma HLS array_partition variable=accum4_out_0 complete
      #pragma HLS array_partition variable=accum4_out_1 complete
      tdf5_accum_4(accum3_out_0, accum4_out_0);
      tdf5_accum_4(accum3_out_1, accum4_out_1);
      data_t accum5_out_0[8];
      data_t accum5_out_1[8];
      #pragma HLS array_partition variable=accum5_out_0 complete
      #pragma HLS array_partition variable=accum5_out_1 complete
      tdf5_accum_5(accum4_out_0, accum5_out_0);
      tdf5_accum_5(accum4_out_1, accum5_out_1);
      data_t accum6_out_0[4];
      data_t accum6_out_1[4];
      #pragma HLS array_partition variable=accum6_out_0 complete
      #pragma HLS array_partition variable=accum6_out_1 complete
      tdf5_accum_6(accum5_out_0, accum6_out_0);
      tdf5_accum_6(accum5_out_1, accum6_out_1);
      sums[0] = tdf5_accum_7(accum6_out_0);
      sums[1] = tdf5_accum_7(accum6_out_1);
