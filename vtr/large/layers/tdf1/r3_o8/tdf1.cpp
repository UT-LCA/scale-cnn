...
// This is a pipelined tree accumulation stage
// It reduces 14 inputs to 8 outputs.
...
void tdf1 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      #pragma HLS array_partition variable=accum2_out_0 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_1 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_2 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_3 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_4 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_5 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_6 cyclic factor=2
      #pragma HLS array_partition variable=accum2_out_7 cyclic factor=2
      ...
      data_t accum3_out_4[4];
      data_t accum3_out_5[4];
      data_t accum3_out_6[4];
      data_t accum3_out_7[4];
      ...
      #pragma HLS array_partition variable=accum3_out_4 complete
      #pragma HLS array_partition variable=accum3_out_5 complete
      #pragma HLS array_partition variable=accum3_out_6 complete
      #pragma HLS array_partition variable=accum3_out_7 complete
      ...
      tdf1_accum_3(accum2_out_4, accum3_out_4);
      tdf1_accum_3(accum2_out_5, accum3_out_5);
      tdf1_accum_3(accum2_out_6, accum3_out_6);
      tdf1_accum_3(accum2_out_7, accum3_out_7);
      ...
      sums[4] = tdf1_accum_4(accum3_out_4);
      sums[5] = tdf1_accum_4(accum3_out_5);
      sums[6] = tdf1_accum_4(accum3_out_6);
      sums[7] = tdf1_accum_4(accum3_out_7);
