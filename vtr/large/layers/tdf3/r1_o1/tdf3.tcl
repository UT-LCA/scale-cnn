...
open_project -reset tdf3_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf3.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf3.cpp"
set_top tdf3_top

# Set variables for the optimization directives
set top tdf3_top
set filter_top tdf3_top
set in_data in_data
...
source tdf3_impl_directives.tcl
source ../tdf3_conv_directives.tcl
