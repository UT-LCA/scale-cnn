...
void tdf7 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum3_out_1[8];
      data_t accum3_out_2[8];
      data_t accum3_out_3[8];
      tdf7_accum_3(accum2_out_0, accum3_out_0);
      tdf7_accum_3(accum2_out_1, accum3_out_1);
      tdf7_accum_3(accum2_out_2, accum3_out_2);
      tdf7_accum_3(accum2_out_3, accum3_out_3);
      data_t accum4_out_0[4];
      data_t accum4_out_1[4];
      data_t accum4_out_2[4];
      data_t accum4_out_3[4];
      #pragma HLS array_partition variable=accum4_out_0 complete
      #pragma HLS array_partition variable=accum4_out_1 complete
      #pragma HLS array_partition variable=accum4_out_2 complete
      #pragma HLS array_partition variable=accum4_out_3 complete
      tdf7_accum_4(accum3_out_0, accum4_out_0);
      tdf7_accum_4(accum3_out_1, accum4_out_1);
      tdf7_accum_4(accum3_out_2, accum4_out_2);
      tdf7_accum_4(accum3_out_3, accum4_out_3);
      sums[0] = tdf7_accum_5(accum4_out_0);
      sums[1] = tdf7_accum_5(accum4_out_1);
      sums[2] = tdf7_accum_5(accum4_out_2);
      sums[3] = tdf7_accum_5(accum4_out_3);
