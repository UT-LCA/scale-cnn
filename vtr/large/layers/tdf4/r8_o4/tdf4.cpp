...
// It reduces 144 inputs to 18 outputs.
...
data_t tdf4_accum_3(data_t accum_in[5]) {
   data_t sum0 = accum_in[4] + accum_in[3];
   data_t sum1 = accum_in[2] + accum_in[1];
   data_t sum2 = accum_in[0] + sum0;
   data_t sum3 = sum1 + sum2;
   return sum3;
