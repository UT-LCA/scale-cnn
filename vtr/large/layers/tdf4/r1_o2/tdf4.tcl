...
open_project -reset tdf4_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf4.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf4.cpp"
set_top tdf4_top

# Set variables for the optimization directives
set top tdf4_top
set filter_top tdf4_top
set in_data in_data
...
source tdf4_impl_directives.tcl
source ../tdf4_conv_directives.tcl
