...
void tdf4_l2_accum (
   ...
   L2_ACC_1: for (uint16_t group = 0; group < OUTPUT_CHANS/2; group++) {
...
data_t tdf4_accum_4(data_t accum_in[3]) {
...
void tdf4 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf4_accum_3(accum2_out_0, accum3_out_0);
      sums[0] = tdf4_accum_4(accum3_out_0);
      ...
      #pragma HLS array_partition variable=l2_products cyclic factor=1 dim=2
      ...
      #pragma HLS array_partition variable=l2_partial_sums cyclic factor=1
