...
// This is a pipelined tree accumulation stage
// It reduces 8 inputs to 2 outputs.
...
data_t tdf3_accum_3(data_t accum_in[2]) {
   data_t sum = 0.0;
...
void tdf3 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf3_accum_1(products[8], accum1_out_8);
      tdf3_accum_1(products[9], accum1_out_9);
      tdf3_accum_1(products[10], accum1_out_10);
      tdf3_accum_1(products[11], accum1_out_11);
      tdf3_accum_1(products[12], accum1_out_12);
      tdf3_accum_1(products[13], accum1_out_13);
      tdf3_accum_1(products[14], accum1_out_14);
      tdf3_accum_1(products[15], accum1_out_15);
      data_t accum2_out_0[2];
      data_t accum2_out_1[2];
      data_t accum2_out_2[2];
      data_t accum2_out_3[2];
      data_t accum2_out_4[2];
      data_t accum2_out_5[2];
      data_t accum2_out_6[2];
      data_t accum2_out_7[2];
      data_t accum2_out_8[2];
      data_t accum2_out_9[2];
      data_t accum2_out_10[2];
      data_t accum2_out_11[2];
      data_t accum2_out_12[2];
      data_t accum2_out_13[2];
      data_t accum2_out_14[2];
      data_t accum2_out_15[2];
      ...
      tdf3_accum_2(accum1_out_8, accum2_out_8);
      tdf3_accum_2(accum1_out_9, accum2_out_9);
      tdf3_accum_2(accum1_out_10, accum2_out_10);
      tdf3_accum_2(accum1_out_11, accum2_out_11);
      tdf3_accum_2(accum1_out_12, accum2_out_12);
      tdf3_accum_2(accum1_out_13, accum2_out_13);
      tdf3_accum_2(accum1_out_14, accum2_out_14);
      tdf3_accum_2(accum1_out_15, accum2_out_15);
      ...
      sums[8] = tdf3_accum_3(accum2_out_8);
      sums[9] = tdf3_accum_3(accum2_out_9);
      sums[10] = tdf3_accum_3(accum2_out_10);
      sums[11] = tdf3_accum_3(accum2_out_11);
      sums[12] = tdf3_accum_3(accum2_out_12);
      sums[13] = tdf3_accum_3(accum2_out_13);
      sums[14] = tdf3_accum_3(accum2_out_14);
      sums[15] = tdf3_accum_3(accum2_out_15);
