...
// The estimated latency is 25 cycles.
data_t tdf3_accum_2(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf3 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      sums[0] = tdf3_accum_2(accum1_out_0);
      sums[1] = tdf3_accum_2(accum1_out_1);
      sums[2] = tdf3_accum_2(accum1_out_2);
      sums[3] = tdf3_accum_2(accum1_out_3);
      sums[4] = tdf3_accum_2(accum1_out_4);
      sums[5] = tdf3_accum_2(accum1_out_5);
      sums[6] = tdf3_accum_2(accum1_out_6);
      sums[7] = tdf3_accum_2(accum1_out_7);
      sums[8] = tdf3_accum_2(accum1_out_8);
      sums[9] = tdf3_accum_2(accum1_out_9);
      sums[10] = tdf3_accum_2(accum1_out_10);
      sums[11] = tdf3_accum_2(accum1_out_11);
      sums[12] = tdf3_accum_2(accum1_out_12);
      sums[13] = tdf3_accum_2(accum1_out_13);
      sums[14] = tdf3_accum_2(accum1_out_14);
      sums[15] = tdf3_accum_2(accum1_out_15);
