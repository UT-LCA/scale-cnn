...
// It reduces 144 inputs to 40 outputs.
...
// This is a pipelined tree accumulation stage
// It reduces 40 inputs to 6 outputs.
...
void tdf5_accum_2(
   ...
   IL_LOOP: for (uint16_t i1 = 0; i1 < 3; i1++) {
      ...
      WRPC_LOOP: for (uint16_t w = 0; w < 16; w++) {
         // Need this bounds check because input length is not necessarily
         // a multiple of words read per cycle.
         vals[w] = (i+w < 40) ? accum_in[i+w] : (data_t)0;
      }
...
data_t tdf5_accum_3(data_t accum_in[6]) {
...
void tdf5 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_0[40];
      data_t accum1_out_1[40];
      data_t accum1_out_2[40];
      data_t accum1_out_3[40];
      data_t accum1_out_4[40];
      data_t accum1_out_5[40];
      data_t accum1_out_6[40];
      data_t accum1_out_7[40];
      ...
      #pragma HLS array_partition variable=accum1_out_5 cyclic factor=8
      #pragma HLS array_partition variable=accum1_out_6 cyclic factor=8
      #pragma HLS array_partition variable=accum1_out_7 cyclic factor=8
      ...
      data_t accum2_out_0[6];
      data_t accum2_out_1[6];
      data_t accum2_out_2[6];
      data_t accum2_out_3[6];
      data_t accum2_out_4[6];
      data_t accum2_out_5[6];
      data_t accum2_out_6[6];
      data_t accum2_out_7[6];
