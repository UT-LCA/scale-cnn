...
void tdf2 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf2_accum_2(accum1_out_16, accum2_out_16);
      tdf2_accum_2(accum1_out_17, accum2_out_17);
      tdf2_accum_2(accum1_out_18, accum2_out_18);
      tdf2_accum_2(accum1_out_19, accum2_out_19);
      tdf2_accum_2(accum1_out_20, accum2_out_20);
      tdf2_accum_2(accum1_out_21, accum2_out_21);
      tdf2_accum_2(accum1_out_22, accum2_out_22);
      tdf2_accum_2(accum1_out_23, accum2_out_23);
      tdf2_accum_2(accum1_out_24, accum2_out_24);
      tdf2_accum_2(accum1_out_25, accum2_out_25);
      tdf2_accum_2(accum1_out_26, accum2_out_26);
      tdf2_accum_2(accum1_out_27, accum2_out_27);
      tdf2_accum_2(accum1_out_28, accum2_out_28);
      tdf2_accum_2(accum1_out_29, accum2_out_29);
      tdf2_accum_2(accum1_out_30, accum2_out_30);
      tdf2_accum_2(accum1_out_31, accum2_out_31);
      ...
      sums[16] = tdf2_accum_3(accum2_out_16);
      sums[17] = tdf2_accum_3(accum2_out_17);
      sums[18] = tdf2_accum_3(accum2_out_18);
      sums[19] = tdf2_accum_3(accum2_out_19);
      sums[20] = tdf2_accum_3(accum2_out_20);
      sums[21] = tdf2_accum_3(accum2_out_21);
      sums[22] = tdf2_accum_3(accum2_out_22);
      sums[23] = tdf2_accum_3(accum2_out_23);
      sums[24] = tdf2_accum_3(accum2_out_24);
      sums[25] = tdf2_accum_3(accum2_out_25);
      sums[26] = tdf2_accum_3(accum2_out_26);
      sums[27] = tdf2_accum_3(accum2_out_27);
      sums[28] = tdf2_accum_3(accum2_out_28);
      sums[29] = tdf2_accum_3(accum2_out_29);
      sums[30] = tdf2_accum_3(accum2_out_30);
      sums[31] = tdf2_accum_3(accum2_out_31);
