...
void tdf8 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_2[80];
      data_t accum1_out_3[80];
      ...
      #pragma HLS array_partition variable=accum1_out_2 cyclic factor=16
      #pragma HLS array_partition variable=accum1_out_3 cyclic factor=16
      ...
      data_t accum2_out_1[12];
      data_t accum2_out_2[12];
      data_t accum2_out_3[12];
      #pragma HLS array_partition variable=accum2_out_0 cyclic factor=4
      #pragma HLS array_partition variable=accum2_out_1 cyclic factor=4
      #pragma HLS array_partition variable=accum2_out_2 cyclic factor=4
      #pragma HLS array_partition variable=accum2_out_3 cyclic factor=4
      ...
      data_t accum3_out_1[2];
      data_t accum3_out_2[2];
      data_t accum3_out_3[2];
      ...
      tdf8_accum_3(accum2_out_1, accum3_out_1);
      tdf8_accum_3(accum2_out_2, accum3_out_2);
      tdf8_accum_3(accum2_out_3, accum3_out_3);
      sums[0] = tdf8_accum_4(accum3_out_0);
      sums[1] = tdf8_accum_4(accum3_out_1);
      sums[2] = tdf8_accum_4(accum3_out_2);
      sums[3] = tdf8_accum_4(accum3_out_3);
