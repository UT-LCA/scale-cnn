...
// It reduces 288 inputs to 32 outputs.
// The estimated latency is 57 cycles.
void tdf8_accum_1 (
   data_t accum_in[288],
   data_t accum_out[32]
) { 
...
// The estimated latency is 25 cycles.
data_t tdf8_accum_3(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf8 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf8_accum_2(accum1_out_1, accum2_out_1);
      tdf8_accum_2(accum1_out_2, accum2_out_2);
      tdf8_accum_2(accum1_out_3, accum2_out_3);
      tdf8_accum_2(accum1_out_4, accum2_out_4);
      tdf8_accum_2(accum1_out_5, accum2_out_5);
      tdf8_accum_2(accum1_out_6, accum2_out_6);
      tdf8_accum_2(accum1_out_7, accum2_out_7);
      tdf8_accum_2(accum1_out_8, accum2_out_8);
      tdf8_accum_2(accum1_out_9, accum2_out_9);
      tdf8_accum_2(accum1_out_10, accum2_out_10);
      tdf8_accum_2(accum1_out_11, accum2_out_11);
      tdf8_accum_2(accum1_out_12, accum2_out_12);
      tdf8_accum_2(accum1_out_13, accum2_out_13);
      tdf8_accum_2(accum1_out_14, accum2_out_14);
      tdf8_accum_2(accum1_out_15, accum2_out_15);
      tdf8_accum_2(accum1_out_16, accum2_out_16);
      tdf8_accum_2(accum1_out_17, accum2_out_17);
      tdf8_accum_2(accum1_out_18, accum2_out_18);
      tdf8_accum_2(accum1_out_19, accum2_out_19);
      tdf8_accum_2(accum1_out_20, accum2_out_20);
      tdf8_accum_2(accum1_out_21, accum2_out_21);
      tdf8_accum_2(accum1_out_22, accum2_out_22);
      tdf8_accum_2(accum1_out_23, accum2_out_23);
      tdf8_accum_2(accum1_out_24, accum2_out_24);
      tdf8_accum_2(accum1_out_25, accum2_out_25);
      tdf8_accum_2(accum1_out_26, accum2_out_26);
      tdf8_accum_2(accum1_out_27, accum2_out_27);
      tdf8_accum_2(accum1_out_28, accum2_out_28);
      tdf8_accum_2(accum1_out_29, accum2_out_29);
      tdf8_accum_2(accum1_out_30, accum2_out_30);
      tdf8_accum_2(accum1_out_31, accum2_out_31);
      sums[0] = tdf8_accum_3(accum2_out_0);
      sums[1] = tdf8_accum_3(accum2_out_1);
      sums[2] = tdf8_accum_3(accum2_out_2);
      sums[3] = tdf8_accum_3(accum2_out_3);
      sums[4] = tdf8_accum_3(accum2_out_4);
      sums[5] = tdf8_accum_3(accum2_out_5);
      sums[6] = tdf8_accum_3(accum2_out_6);
      sums[7] = tdf8_accum_3(accum2_out_7);
      sums[8] = tdf8_accum_3(accum2_out_8);
      sums[9] = tdf8_accum_3(accum2_out_9);
      sums[10] = tdf8_accum_3(accum2_out_10);
      sums[11] = tdf8_accum_3(accum2_out_11);
      sums[12] = tdf8_accum_3(accum2_out_12);
      sums[13] = tdf8_accum_3(accum2_out_13);
      sums[14] = tdf8_accum_3(accum2_out_14);
      sums[15] = tdf8_accum_3(accum2_out_15);
      sums[16] = tdf8_accum_3(accum2_out_16);
      sums[17] = tdf8_accum_3(accum2_out_17);
      sums[18] = tdf8_accum_3(accum2_out_18);
      sums[19] = tdf8_accum_3(accum2_out_19);
      sums[20] = tdf8_accum_3(accum2_out_20);
      sums[21] = tdf8_accum_3(accum2_out_21);
      sums[22] = tdf8_accum_3(accum2_out_22);
      sums[23] = tdf8_accum_3(accum2_out_23);
      sums[24] = tdf8_accum_3(accum2_out_24);
      sums[25] = tdf8_accum_3(accum2_out_25);
      sums[26] = tdf8_accum_3(accum2_out_26);
      sums[27] = tdf8_accum_3(accum2_out_27);
      sums[28] = tdf8_accum_3(accum2_out_28);
      sums[29] = tdf8_accum_3(accum2_out_29);
      sums[30] = tdf8_accum_3(accum2_out_30);
      sums[31] = tdf8_accum_3(accum2_out_31);
