...
// The estimated latency is 35 cycles.
void tdf8_accum_1 (
   data_t accum_in[288],
   data_t accum_out[64]
) { 
...
data_t tdf8_accum_3(data_t accum_in[11]) {
   data_t sum = 0.0;
...
void tdf8 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_8[64];
      data_t accum1_out_9[64];
      data_t accum1_out_10[64];
      data_t accum1_out_11[64];
      data_t accum1_out_12[64];
      data_t accum1_out_13[64];
      data_t accum1_out_14[64];
      data_t accum1_out_15[64];
      ...
      #pragma HLS array_partition variable=accum1_out_8 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_9 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_10 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_11 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_12 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_13 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_14 cyclic factor=3
      #pragma HLS array_partition variable=accum1_out_15 cyclic factor=3
      ...
      data_t accum2_out_8[11];
      data_t accum2_out_9[11];
      data_t accum2_out_10[11];
      data_t accum2_out_11[11];
      data_t accum2_out_12[11];
      data_t accum2_out_13[11];
      data_t accum2_out_14[11];
      data_t accum2_out_15[11];
