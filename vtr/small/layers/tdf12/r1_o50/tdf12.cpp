...
data_t tdf12_accum_2(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf12 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      sums[8] = tdf12_accum_2(accum1_out_8);
      sums[9] = tdf12_accum_2(accum1_out_9);
      sums[10] = tdf12_accum_2(accum1_out_10);
      sums[11] = tdf12_accum_2(accum1_out_11);
      sums[12] = tdf12_accum_2(accum1_out_12);
      sums[13] = tdf12_accum_2(accum1_out_13);
      sums[14] = tdf12_accum_2(accum1_out_14);
      sums[15] = tdf12_accum_2(accum1_out_15);
      sums[16] = tdf12_accum_2(accum1_out_16);
      sums[17] = tdf12_accum_2(accum1_out_17);
      sums[18] = tdf12_accum_2(accum1_out_18);
      sums[19] = tdf12_accum_2(accum1_out_19);
      sums[20] = tdf12_accum_2(accum1_out_20);
      sums[21] = tdf12_accum_2(accum1_out_21);
      sums[22] = tdf12_accum_2(accum1_out_22);
      sums[23] = tdf12_accum_2(accum1_out_23);
      sums[24] = tdf12_accum_2(accum1_out_24);
      sums[25] = tdf12_accum_2(accum1_out_25);
      sums[26] = tdf12_accum_2(accum1_out_26);
      sums[27] = tdf12_accum_2(accum1_out_27);
      sums[28] = tdf12_accum_2(accum1_out_28);
      sums[29] = tdf12_accum_2(accum1_out_29);
      sums[30] = tdf12_accum_2(accum1_out_30);
      sums[31] = tdf12_accum_2(accum1_out_31);
      sums[32] = tdf12_accum_2(accum1_out_32);
      sums[33] = tdf12_accum_2(accum1_out_33);
      sums[34] = tdf12_accum_2(accum1_out_34);
      sums[35] = tdf12_accum_2(accum1_out_35);
      sums[36] = tdf12_accum_2(accum1_out_36);
      sums[37] = tdf12_accum_2(accum1_out_37);
      sums[38] = tdf12_accum_2(accum1_out_38);
      sums[39] = tdf12_accum_2(accum1_out_39);
      sums[40] = tdf12_accum_2(accum1_out_40);
      sums[41] = tdf12_accum_2(accum1_out_41);
      sums[42] = tdf12_accum_2(accum1_out_42);
      sums[43] = tdf12_accum_2(accum1_out_43);
      sums[44] = tdf12_accum_2(accum1_out_44);
      sums[45] = tdf12_accum_2(accum1_out_45);
      sums[46] = tdf12_accum_2(accum1_out_46);
      sums[47] = tdf12_accum_2(accum1_out_47);
      sums[48] = tdf12_accum_2(accum1_out_48);
      sums[49] = tdf12_accum_2(accum1_out_49);
