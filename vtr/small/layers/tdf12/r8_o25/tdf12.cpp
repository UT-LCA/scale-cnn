...
// This is a pipelined tree accumulation stage
// It reduces 16 inputs to 4 outputs.
...
void tdf12 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum2_out_8[4];
      data_t accum2_out_9[4];
      data_t accum2_out_10[4];
      data_t accum2_out_11[4];
      data_t accum2_out_12[4];
      data_t accum2_out_13[4];
      data_t accum2_out_14[4];
      data_t accum2_out_15[4];
      data_t accum2_out_16[4];
      data_t accum2_out_17[4];
      data_t accum2_out_18[4];
      data_t accum2_out_19[4];
      data_t accum2_out_20[4];
      data_t accum2_out_21[4];
      data_t accum2_out_22[4];
      data_t accum2_out_23[4];
      data_t accum2_out_24[4];
      ...
      #pragma HLS array_partition variable=accum2_out_16 complete
      #pragma HLS array_partition variable=accum2_out_17 complete
      #pragma HLS array_partition variable=accum2_out_18 complete
      #pragma HLS array_partition variable=accum2_out_19 complete
      #pragma HLS array_partition variable=accum2_out_20 complete
      #pragma HLS array_partition variable=accum2_out_21 complete
      #pragma HLS array_partition variable=accum2_out_22 complete
      #pragma HLS array_partition variable=accum2_out_23 complete
      #pragma HLS array_partition variable=accum2_out_24 complete
