...
data_t tdf12_accum_3(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf12 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_32[32];
      data_t accum1_out_33[32];
      data_t accum1_out_34[32];
      data_t accum1_out_35[32];
      data_t accum1_out_36[32];
      data_t accum1_out_37[32];
      data_t accum1_out_38[32];
      data_t accum1_out_39[32];
      data_t accum1_out_40[32];
      data_t accum1_out_41[32];
      data_t accum1_out_42[32];
      data_t accum1_out_43[32];
      data_t accum1_out_44[32];
      data_t accum1_out_45[32];
      data_t accum1_out_46[32];
      data_t accum1_out_47[32];
      data_t accum1_out_48[32];
      data_t accum1_out_49[32];
      ...
      #pragma HLS array_partition variable=accum1_out_32 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_33 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_34 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_35 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_36 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_37 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_38 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_39 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_40 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_41 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_42 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_43 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_44 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_45 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_46 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_47 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_48 cyclic factor=2
      #pragma HLS array_partition variable=accum1_out_49 cyclic factor=2
      ...
      tdf12_accum_1(products[8], accum1_out_8);
      tdf12_accum_1(products[9], accum1_out_9);
      tdf12_accum_1(products[10], accum1_out_10);
      tdf12_accum_1(products[11], accum1_out_11);
      tdf12_accum_1(products[12], accum1_out_12);
      tdf12_accum_1(products[13], accum1_out_13);
      tdf12_accum_1(products[14], accum1_out_14);
      tdf12_accum_1(products[15], accum1_out_15);
      tdf12_accum_1(products[16], accum1_out_16);
      tdf12_accum_1(products[17], accum1_out_17);
      tdf12_accum_1(products[18], accum1_out_18);
      tdf12_accum_1(products[19], accum1_out_19);
      tdf12_accum_1(products[20], accum1_out_20);
      tdf12_accum_1(products[21], accum1_out_21);
      tdf12_accum_1(products[22], accum1_out_22);
      tdf12_accum_1(products[23], accum1_out_23);
      tdf12_accum_1(products[24], accum1_out_24);
      tdf12_accum_1(products[25], accum1_out_25);
      tdf12_accum_1(products[26], accum1_out_26);
      tdf12_accum_1(products[27], accum1_out_27);
      tdf12_accum_1(products[28], accum1_out_28);
      tdf12_accum_1(products[29], accum1_out_29);
      tdf12_accum_1(products[30], accum1_out_30);
      tdf12_accum_1(products[31], accum1_out_31);
      tdf12_accum_1(products[32], accum1_out_32);
      tdf12_accum_1(products[33], accum1_out_33);
      tdf12_accum_1(products[34], accum1_out_34);
      tdf12_accum_1(products[35], accum1_out_35);
      tdf12_accum_1(products[36], accum1_out_36);
      tdf12_accum_1(products[37], accum1_out_37);
      tdf12_accum_1(products[38], accum1_out_38);
      tdf12_accum_1(products[39], accum1_out_39);
      tdf12_accum_1(products[40], accum1_out_40);
      tdf12_accum_1(products[41], accum1_out_41);
      tdf12_accum_1(products[42], accum1_out_42);
      tdf12_accum_1(products[43], accum1_out_43);
      tdf12_accum_1(products[44], accum1_out_44);
      tdf12_accum_1(products[45], accum1_out_45);
      tdf12_accum_1(products[46], accum1_out_46);
      tdf12_accum_1(products[47], accum1_out_47);
      tdf12_accum_1(products[48], accum1_out_48);
      tdf12_accum_1(products[49], accum1_out_49);
      ...
      data_t accum2_out_32[8];
      data_t accum2_out_33[8];
      data_t accum2_out_34[8];
      data_t accum2_out_35[8];
      data_t accum2_out_36[8];
      data_t accum2_out_37[8];
      data_t accum2_out_38[8];
      data_t accum2_out_39[8];
      data_t accum2_out_40[8];
      data_t accum2_out_41[8];
      data_t accum2_out_42[8];
      data_t accum2_out_43[8];
      data_t accum2_out_44[8];
      data_t accum2_out_45[8];
      data_t accum2_out_46[8];
      data_t accum2_out_47[8];
      data_t accum2_out_48[8];
      data_t accum2_out_49[8];
      ...
      tdf12_accum_2(accum1_out_5, accum2_out_5);
      tdf12_accum_2(accum1_out_6, accum2_out_6);
      tdf12_accum_2(accum1_out_7, accum2_out_7);
      tdf12_accum_2(accum1_out_8, accum2_out_8);
      tdf12_accum_2(accum1_out_9, accum2_out_9);
      tdf12_accum_2(accum1_out_10, accum2_out_10);
      tdf12_accum_2(accum1_out_11, accum2_out_11);
      tdf12_accum_2(accum1_out_12, accum2_out_12);
      tdf12_accum_2(accum1_out_13, accum2_out_13);
      tdf12_accum_2(accum1_out_14, accum2_out_14);
      tdf12_accum_2(accum1_out_15, accum2_out_15);
      tdf12_accum_2(accum1_out_16, accum2_out_16);
      tdf12_accum_2(accum1_out_17, accum2_out_17);
      tdf12_accum_2(accum1_out_18, accum2_out_18);
      tdf12_accum_2(accum1_out_19, accum2_out_19);
      tdf12_accum_2(accum1_out_20, accum2_out_20);
      tdf12_accum_2(accum1_out_21, accum2_out_21);
      tdf12_accum_2(accum1_out_22, accum2_out_22);
      tdf12_accum_2(accum1_out_23, accum2_out_23);
      tdf12_accum_2(accum1_out_24, accum2_out_24);
      tdf12_accum_2(accum1_out_25, accum2_out_25);
      tdf12_accum_2(accum1_out_26, accum2_out_26);
      tdf12_accum_2(accum1_out_27, accum2_out_27);
      tdf12_accum_2(accum1_out_28, accum2_out_28);
      tdf12_accum_2(accum1_out_29, accum2_out_29);
      tdf12_accum_2(accum1_out_30, accum2_out_30);
      tdf12_accum_2(accum1_out_31, accum2_out_31);
      tdf12_accum_2(accum1_out_32, accum2_out_32);
      tdf12_accum_2(accum1_out_33, accum2_out_33);
      tdf12_accum_2(accum1_out_34, accum2_out_34);
      tdf12_accum_2(accum1_out_35, accum2_out_35);
      tdf12_accum_2(accum1_out_36, accum2_out_36);
      tdf12_accum_2(accum1_out_37, accum2_out_37);
      tdf12_accum_2(accum1_out_38, accum2_out_38);
      tdf12_accum_2(accum1_out_39, accum2_out_39);
      tdf12_accum_2(accum1_out_40, accum2_out_40);
      tdf12_accum_2(accum1_out_41, accum2_out_41);
      tdf12_accum_2(accum1_out_42, accum2_out_42);
      tdf12_accum_2(accum1_out_43, accum2_out_43);
      tdf12_accum_2(accum1_out_44, accum2_out_44);
      tdf12_accum_2(accum1_out_45, accum2_out_45);
      tdf12_accum_2(accum1_out_46, accum2_out_46);
      tdf12_accum_2(accum1_out_47, accum2_out_47);
      tdf12_accum_2(accum1_out_48, accum2_out_48);
      tdf12_accum_2(accum1_out_49, accum2_out_49);
      ...
      sums[5] = tdf12_accum_3(accum2_out_5);
      sums[6] = tdf12_accum_3(accum2_out_6);
      sums[7] = tdf12_accum_3(accum2_out_7);
      sums[8] = tdf12_accum_3(accum2_out_8);
      sums[9] = tdf12_accum_3(accum2_out_9);
      sums[10] = tdf12_accum_3(accum2_out_10);
      sums[11] = tdf12_accum_3(accum2_out_11);
      sums[12] = tdf12_accum_3(accum2_out_12);
      sums[13] = tdf12_accum_3(accum2_out_13);
      sums[14] = tdf12_accum_3(accum2_out_14);
      sums[15] = tdf12_accum_3(accum2_out_15);
      sums[16] = tdf12_accum_3(accum2_out_16);
      sums[17] = tdf12_accum_3(accum2_out_17);
      sums[18] = tdf12_accum_3(accum2_out_18);
      sums[19] = tdf12_accum_3(accum2_out_19);
      sums[20] = tdf12_accum_3(accum2_out_20);
      sums[21] = tdf12_accum_3(accum2_out_21);
      sums[22] = tdf12_accum_3(accum2_out_22);
      sums[23] = tdf12_accum_3(accum2_out_23);
      sums[24] = tdf12_accum_3(accum2_out_24);
      sums[25] = tdf12_accum_3(accum2_out_25);
      sums[26] = tdf12_accum_3(accum2_out_26);
      sums[27] = tdf12_accum_3(accum2_out_27);
      sums[28] = tdf12_accum_3(accum2_out_28);
      sums[29] = tdf12_accum_3(accum2_out_29);
      sums[30] = tdf12_accum_3(accum2_out_30);
      sums[31] = tdf12_accum_3(accum2_out_31);
      sums[32] = tdf12_accum_3(accum2_out_32);
      sums[33] = tdf12_accum_3(accum2_out_33);
      sums[34] = tdf12_accum_3(accum2_out_34);
      sums[35] = tdf12_accum_3(accum2_out_35);
      sums[36] = tdf12_accum_3(accum2_out_36);
      sums[37] = tdf12_accum_3(accum2_out_37);
      sums[38] = tdf12_accum_3(accum2_out_38);
      sums[39] = tdf12_accum_3(accum2_out_39);
      sums[40] = tdf12_accum_3(accum2_out_40);
      sums[41] = tdf12_accum_3(accum2_out_41);
      sums[42] = tdf12_accum_3(accum2_out_42);
      sums[43] = tdf12_accum_3(accum2_out_43);
      sums[44] = tdf12_accum_3(accum2_out_44);
      sums[45] = tdf12_accum_3(accum2_out_45);
      sums[46] = tdf12_accum_3(accum2_out_46);
      sums[47] = tdf12_accum_3(accum2_out_47);
      sums[48] = tdf12_accum_3(accum2_out_48);
      sums[49] = tdf12_accum_3(accum2_out_49);
