...
// It reduces 7 inputs to 1 output.
// The estimated latency is 22 cycles.
data_t tdf1_accum_3(data_t accum_in[7]) {
   data_t sum = 0.0;
   for (int i = 0; i < 7; i++) sum += accum_in[i];
   return sum;
}
...
void tdf1 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_4[14];
      data_t accum1_out_5[14];
      data_t accum1_out_6[14];
      data_t accum1_out_7[14];
      data_t accum1_out_8[14];
      data_t accum1_out_9[14];
      data_t accum1_out_10[14];
      data_t accum1_out_11[14];
      data_t accum1_out_12[14];
      data_t accum1_out_13[14];
      data_t accum1_out_14[14];
      data_t accum1_out_15[14];
      ...
      tdf1_accum_1(products[4], accum1_out_4);
      tdf1_accum_1(products[5], accum1_out_5);
      tdf1_accum_1(products[6], accum1_out_6);
      tdf1_accum_1(products[7], accum1_out_7);
      tdf1_accum_1(products[8], accum1_out_8);
      tdf1_accum_1(products[9], accum1_out_9);
      tdf1_accum_1(products[10], accum1_out_10);
      tdf1_accum_1(products[11], accum1_out_11);
      tdf1_accum_1(products[12], accum1_out_12);
      tdf1_accum_1(products[13], accum1_out_13);
      tdf1_accum_1(products[14], accum1_out_14);
      tdf1_accum_1(products[15], accum1_out_15);
      data_t accum2_out_0[7];
      data_t accum2_out_1[7];
      data_t accum2_out_2[7];
      data_t accum2_out_3[7];
      data_t accum2_out_4[7];
      data_t accum2_out_5[7];
      data_t accum2_out_6[7];
      data_t accum2_out_7[7];
      data_t accum2_out_8[7];
      data_t accum2_out_9[7];
      data_t accum2_out_10[7];
      data_t accum2_out_11[7];
      data_t accum2_out_12[7];
      data_t accum2_out_13[7];
      data_t accum2_out_14[7];
      data_t accum2_out_15[7];
      ...
      tdf1_accum_2(accum1_out_4, accum2_out_4);
      tdf1_accum_2(accum1_out_5, accum2_out_5);
      tdf1_accum_2(accum1_out_6, accum2_out_6);
      tdf1_accum_2(accum1_out_7, accum2_out_7);
      tdf1_accum_2(accum1_out_8, accum2_out_8);
      tdf1_accum_2(accum1_out_9, accum2_out_9);
      tdf1_accum_2(accum1_out_10, accum2_out_10);
      tdf1_accum_2(accum1_out_11, accum2_out_11);
      tdf1_accum_2(accum1_out_12, accum2_out_12);
      tdf1_accum_2(accum1_out_13, accum2_out_13);
      tdf1_accum_2(accum1_out_14, accum2_out_14);
      tdf1_accum_2(accum1_out_15, accum2_out_15);
      sums[0] = tdf1_accum_3(accum2_out_0);
      sums[1] = tdf1_accum_3(accum2_out_1);
      sums[2] = tdf1_accum_3(accum2_out_2);
      sums[3] = tdf1_accum_3(accum2_out_3);
      sums[4] = tdf1_accum_3(accum2_out_4);
      sums[5] = tdf1_accum_3(accum2_out_5);
      sums[6] = tdf1_accum_3(accum2_out_6);
      sums[7] = tdf1_accum_3(accum2_out_7);
      sums[8] = tdf1_accum_3(accum2_out_8);
      sums[9] = tdf1_accum_3(accum2_out_9);
      sums[10] = tdf1_accum_3(accum2_out_10);
      sums[11] = tdf1_accum_3(accum2_out_11);
      sums[12] = tdf1_accum_3(accum2_out_12);
      sums[13] = tdf1_accum_3(accum2_out_13);
      sums[14] = tdf1_accum_3(accum2_out_14);
      sums[15] = tdf1_accum_3(accum2_out_15);
