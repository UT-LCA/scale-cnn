...
// The estimated latency is 49 cycles.
data_t tdf4_accum_2(data_t accum_in[16]) {
   data_t sum = 0.0;
...
void tdf4 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf4_accum_1(products[8], accum1_out_8);
      tdf4_accum_1(products[9], accum1_out_9);
      tdf4_accum_1(products[10], accum1_out_10);
      tdf4_accum_1(products[11], accum1_out_11);
      tdf4_accum_1(products[12], accum1_out_12);
      tdf4_accum_1(products[13], accum1_out_13);
      tdf4_accum_1(products[14], accum1_out_14);
      tdf4_accum_1(products[15], accum1_out_15);
      tdf4_accum_1(products[16], accum1_out_16);
      tdf4_accum_1(products[17], accum1_out_17);
      tdf4_accum_1(products[18], accum1_out_18);
      tdf4_accum_1(products[19], accum1_out_19);
      tdf4_accum_1(products[20], accum1_out_20);
      tdf4_accum_1(products[21], accum1_out_21);
      tdf4_accum_1(products[22], accum1_out_22);
      tdf4_accum_1(products[23], accum1_out_23);
      tdf4_accum_1(products[24], accum1_out_24);
      tdf4_accum_1(products[25], accum1_out_25);
      tdf4_accum_1(products[26], accum1_out_26);
      tdf4_accum_1(products[27], accum1_out_27);
      tdf4_accum_1(products[28], accum1_out_28);
      tdf4_accum_1(products[29], accum1_out_29);
      tdf4_accum_1(products[30], accum1_out_30);
      tdf4_accum_1(products[31], accum1_out_31);
      tdf4_accum_1(products[32], accum1_out_32);
      tdf4_accum_1(products[33], accum1_out_33);
      tdf4_accum_1(products[34], accum1_out_34);
      tdf4_accum_1(products[35], accum1_out_35);
      tdf4_accum_1(products[36], accum1_out_36);
      tdf4_accum_1(products[37], accum1_out_37);
      tdf4_accum_1(products[38], accum1_out_38);
      tdf4_accum_1(products[39], accum1_out_39);
      tdf4_accum_1(products[40], accum1_out_40);
      tdf4_accum_1(products[41], accum1_out_41);
      tdf4_accum_1(products[42], accum1_out_42);
      tdf4_accum_1(products[43], accum1_out_43);
      tdf4_accum_1(products[44], accum1_out_44);
      tdf4_accum_1(products[45], accum1_out_45);
      tdf4_accum_1(products[46], accum1_out_46);
      tdf4_accum_1(products[47], accum1_out_47);
      tdf4_accum_1(products[48], accum1_out_48);
      tdf4_accum_1(products[49], accum1_out_49);
      tdf4_accum_1(products[50], accum1_out_50);
      tdf4_accum_1(products[51], accum1_out_51);
      tdf4_accum_1(products[52], accum1_out_52);
      tdf4_accum_1(products[53], accum1_out_53);
      tdf4_accum_1(products[54], accum1_out_54);
      tdf4_accum_1(products[55], accum1_out_55);
      tdf4_accum_1(products[56], accum1_out_56);
      tdf4_accum_1(products[57], accum1_out_57);
      tdf4_accum_1(products[58], accum1_out_58);
      tdf4_accum_1(products[59], accum1_out_59);
      tdf4_accum_1(products[60], accum1_out_60);
      tdf4_accum_1(products[61], accum1_out_61);
      tdf4_accum_1(products[62], accum1_out_62);
      tdf4_accum_1(products[63], accum1_out_63);
      ...
      sums[8] = tdf4_accum_2(accum1_out_8);
      sums[9] = tdf4_accum_2(accum1_out_9);
      sums[10] = tdf4_accum_2(accum1_out_10);
      sums[11] = tdf4_accum_2(accum1_out_11);
      sums[12] = tdf4_accum_2(accum1_out_12);
      sums[13] = tdf4_accum_2(accum1_out_13);
      sums[14] = tdf4_accum_2(accum1_out_14);
      sums[15] = tdf4_accum_2(accum1_out_15);
      sums[16] = tdf4_accum_2(accum1_out_16);
      sums[17] = tdf4_accum_2(accum1_out_17);
      sums[18] = tdf4_accum_2(accum1_out_18);
      sums[19] = tdf4_accum_2(accum1_out_19);
      sums[20] = tdf4_accum_2(accum1_out_20);
      sums[21] = tdf4_accum_2(accum1_out_21);
      sums[22] = tdf4_accum_2(accum1_out_22);
      sums[23] = tdf4_accum_2(accum1_out_23);
      sums[24] = tdf4_accum_2(accum1_out_24);
      sums[25] = tdf4_accum_2(accum1_out_25);
      sums[26] = tdf4_accum_2(accum1_out_26);
      sums[27] = tdf4_accum_2(accum1_out_27);
      sums[28] = tdf4_accum_2(accum1_out_28);
      sums[29] = tdf4_accum_2(accum1_out_29);
      sums[30] = tdf4_accum_2(accum1_out_30);
      sums[31] = tdf4_accum_2(accum1_out_31);
      sums[32] = tdf4_accum_2(accum1_out_32);
      sums[33] = tdf4_accum_2(accum1_out_33);
      sums[34] = tdf4_accum_2(accum1_out_34);
      sums[35] = tdf4_accum_2(accum1_out_35);
      sums[36] = tdf4_accum_2(accum1_out_36);
      sums[37] = tdf4_accum_2(accum1_out_37);
      sums[38] = tdf4_accum_2(accum1_out_38);
      sums[39] = tdf4_accum_2(accum1_out_39);
      sums[40] = tdf4_accum_2(accum1_out_40);
      sums[41] = tdf4_accum_2(accum1_out_41);
      sums[42] = tdf4_accum_2(accum1_out_42);
      sums[43] = tdf4_accum_2(accum1_out_43);
      sums[44] = tdf4_accum_2(accum1_out_44);
      sums[45] = tdf4_accum_2(accum1_out_45);
      sums[46] = tdf4_accum_2(accum1_out_46);
      sums[47] = tdf4_accum_2(accum1_out_47);
      sums[48] = tdf4_accum_2(accum1_out_48);
      sums[49] = tdf4_accum_2(accum1_out_49);
      sums[50] = tdf4_accum_2(accum1_out_50);
      sums[51] = tdf4_accum_2(accum1_out_51);
      sums[52] = tdf4_accum_2(accum1_out_52);
      sums[53] = tdf4_accum_2(accum1_out_53);
      sums[54] = tdf4_accum_2(accum1_out_54);
      sums[55] = tdf4_accum_2(accum1_out_55);
      sums[56] = tdf4_accum_2(accum1_out_56);
      sums[57] = tdf4_accum_2(accum1_out_57);
      sums[58] = tdf4_accum_2(accum1_out_58);
      sums[59] = tdf4_accum_2(accum1_out_59);
      sums[60] = tdf4_accum_2(accum1_out_60);
      sums[61] = tdf4_accum_2(accum1_out_61);
      sums[62] = tdf4_accum_2(accum1_out_62);
      sums[63] = tdf4_accum_2(accum1_out_63);
