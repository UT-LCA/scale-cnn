...
// It reduces 144 inputs to 10 outputs.
...
// The estimated latency is 10 cycles.
void tdf4_accum_2(
   data_t accum_in[10], 
   data_t accum_out[3]
) {
...
// The estimated latency is 10 cycles.
data_t tdf4_accum_3(data_t accum_in[3]) {
   data_t sum = 0.0;
...
void tdf4 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_0[10];
      data_t accum1_out_1[10];
      data_t accum1_out_2[10];
      data_t accum1_out_3[10];
      ...
      data_t accum2_out_1[3];
      data_t accum2_out_2[3];
      data_t accum2_out_3[3];
