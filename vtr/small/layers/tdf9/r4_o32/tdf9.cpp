...
// The estimated latency is 53 cycles.
void tdf9_accum_1 (
   data_t accum_in[256],
   data_t accum_out[32]
) { 
...
void tdf9 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf9_accum_2(accum1_out_8, accum2_out_8);
      tdf9_accum_2(accum1_out_9, accum2_out_9);
      tdf9_accum_2(accum1_out_10, accum2_out_10);
      tdf9_accum_2(accum1_out_11, accum2_out_11);
      tdf9_accum_2(accum1_out_12, accum2_out_12);
      tdf9_accum_2(accum1_out_13, accum2_out_13);
      tdf9_accum_2(accum1_out_14, accum2_out_14);
      tdf9_accum_2(accum1_out_15, accum2_out_15);
      tdf9_accum_2(accum1_out_16, accum2_out_16);
      tdf9_accum_2(accum1_out_17, accum2_out_17);
      tdf9_accum_2(accum1_out_18, accum2_out_18);
      tdf9_accum_2(accum1_out_19, accum2_out_19);
      tdf9_accum_2(accum1_out_20, accum2_out_20);
      tdf9_accum_2(accum1_out_21, accum2_out_21);
      tdf9_accum_2(accum1_out_22, accum2_out_22);
      tdf9_accum_2(accum1_out_23, accum2_out_23);
      tdf9_accum_2(accum1_out_24, accum2_out_24);
      tdf9_accum_2(accum1_out_25, accum2_out_25);
      tdf9_accum_2(accum1_out_26, accum2_out_26);
      tdf9_accum_2(accum1_out_27, accum2_out_27);
      tdf9_accum_2(accum1_out_28, accum2_out_28);
      tdf9_accum_2(accum1_out_29, accum2_out_29);
      tdf9_accum_2(accum1_out_30, accum2_out_30);
      tdf9_accum_2(accum1_out_31, accum2_out_31);
      ...
      sums[8] = tdf9_accum_3(accum2_out_8);
      sums[9] = tdf9_accum_3(accum2_out_9);
      sums[10] = tdf9_accum_3(accum2_out_10);
      sums[11] = tdf9_accum_3(accum2_out_11);
      sums[12] = tdf9_accum_3(accum2_out_12);
      sums[13] = tdf9_accum_3(accum2_out_13);
      sums[14] = tdf9_accum_3(accum2_out_14);
      sums[15] = tdf9_accum_3(accum2_out_15);
      sums[16] = tdf9_accum_3(accum2_out_16);
      sums[17] = tdf9_accum_3(accum2_out_17);
      sums[18] = tdf9_accum_3(accum2_out_18);
      sums[19] = tdf9_accum_3(accum2_out_19);
      sums[20] = tdf9_accum_3(accum2_out_20);
      sums[21] = tdf9_accum_3(accum2_out_21);
      sums[22] = tdf9_accum_3(accum2_out_22);
      sums[23] = tdf9_accum_3(accum2_out_23);
      sums[24] = tdf9_accum_3(accum2_out_24);
      sums[25] = tdf9_accum_3(accum2_out_25);
      sums[26] = tdf9_accum_3(accum2_out_26);
      sums[27] = tdf9_accum_3(accum2_out_27);
      sums[28] = tdf9_accum_3(accum2_out_28);
      sums[29] = tdf9_accum_3(accum2_out_29);
      sums[30] = tdf9_accum_3(accum2_out_30);
      sums[31] = tdf9_accum_3(accum2_out_31);
