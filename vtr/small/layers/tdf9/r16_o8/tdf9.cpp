...
void tdf9 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      #pragma HLS array_partition variable=accum1_out_4 cyclic factor=4
      #pragma HLS array_partition variable=accum1_out_5 cyclic factor=4
      #pragma HLS array_partition variable=accum1_out_6 cyclic factor=4
      #pragma HLS array_partition variable=accum1_out_7 cyclic factor=4
