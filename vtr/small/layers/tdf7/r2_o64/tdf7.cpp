...
void tdf7_l2_accum (
   ...
   L2_ACC_1: for (uint16_t group = 0; group < OUTPUT_CHANS/32; group++) {
...
// It reduces 288 inputs to 16 outputs.
// The estimated latency is 85 cycles.
void tdf7_accum_1 (
   data_t accum_in[288],
   data_t accum_out[16]
) { 
...
data_t tdf7_accum_2(data_t accum_in[16]) {
   data_t sum = 0.0;
...
void tdf7 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf7_accum_1(products[2], accum1_out_2);
      tdf7_accum_1(products[3], accum1_out_3);
      tdf7_accum_1(products[4], accum1_out_4);
      tdf7_accum_1(products[5], accum1_out_5);
      tdf7_accum_1(products[6], accum1_out_6);
      tdf7_accum_1(products[7], accum1_out_7);
      tdf7_accum_1(products[8], accum1_out_8);
      tdf7_accum_1(products[9], accum1_out_9);
      tdf7_accum_1(products[10], accum1_out_10);
      tdf7_accum_1(products[11], accum1_out_11);
      tdf7_accum_1(products[12], accum1_out_12);
      tdf7_accum_1(products[13], accum1_out_13);
      tdf7_accum_1(products[14], accum1_out_14);
      tdf7_accum_1(products[15], accum1_out_15);
      tdf7_accum_1(products[16], accum1_out_16);
      tdf7_accum_1(products[17], accum1_out_17);
      tdf7_accum_1(products[18], accum1_out_18);
      tdf7_accum_1(products[19], accum1_out_19);
      tdf7_accum_1(products[20], accum1_out_20);
      tdf7_accum_1(products[21], accum1_out_21);
      tdf7_accum_1(products[22], accum1_out_22);
      tdf7_accum_1(products[23], accum1_out_23);
      tdf7_accum_1(products[24], accum1_out_24);
      tdf7_accum_1(products[25], accum1_out_25);
      tdf7_accum_1(products[26], accum1_out_26);
      tdf7_accum_1(products[27], accum1_out_27);
      tdf7_accum_1(products[28], accum1_out_28);
      tdf7_accum_1(products[29], accum1_out_29);
      tdf7_accum_1(products[30], accum1_out_30);
      tdf7_accum_1(products[31], accum1_out_31);
      tdf7_accum_1(products[32], accum1_out_32);
      tdf7_accum_1(products[33], accum1_out_33);
      tdf7_accum_1(products[34], accum1_out_34);
      tdf7_accum_1(products[35], accum1_out_35);
      tdf7_accum_1(products[36], accum1_out_36);
      tdf7_accum_1(products[37], accum1_out_37);
      tdf7_accum_1(products[38], accum1_out_38);
      tdf7_accum_1(products[39], accum1_out_39);
      tdf7_accum_1(products[40], accum1_out_40);
      tdf7_accum_1(products[41], accum1_out_41);
      tdf7_accum_1(products[42], accum1_out_42);
      tdf7_accum_1(products[43], accum1_out_43);
      tdf7_accum_1(products[44], accum1_out_44);
      tdf7_accum_1(products[45], accum1_out_45);
      tdf7_accum_1(products[46], accum1_out_46);
      tdf7_accum_1(products[47], accum1_out_47);
      tdf7_accum_1(products[48], accum1_out_48);
      tdf7_accum_1(products[49], accum1_out_49);
      tdf7_accum_1(products[50], accum1_out_50);
      tdf7_accum_1(products[51], accum1_out_51);
      tdf7_accum_1(products[52], accum1_out_52);
      tdf7_accum_1(products[53], accum1_out_53);
      tdf7_accum_1(products[54], accum1_out_54);
      tdf7_accum_1(products[55], accum1_out_55);
      tdf7_accum_1(products[56], accum1_out_56);
      tdf7_accum_1(products[57], accum1_out_57);
      tdf7_accum_1(products[58], accum1_out_58);
      tdf7_accum_1(products[59], accum1_out_59);
      tdf7_accum_1(products[60], accum1_out_60);
      tdf7_accum_1(products[61], accum1_out_61);
      tdf7_accum_1(products[62], accum1_out_62);
      tdf7_accum_1(products[63], accum1_out_63);
      sums[0] = tdf7_accum_2(accum1_out_0);
      sums[1] = tdf7_accum_2(accum1_out_1);
      sums[2] = tdf7_accum_2(accum1_out_2);
      sums[3] = tdf7_accum_2(accum1_out_3);
      sums[4] = tdf7_accum_2(accum1_out_4);
      sums[5] = tdf7_accum_2(accum1_out_5);
      sums[6] = tdf7_accum_2(accum1_out_6);
      sums[7] = tdf7_accum_2(accum1_out_7);
      sums[8] = tdf7_accum_2(accum1_out_8);
      sums[9] = tdf7_accum_2(accum1_out_9);
      sums[10] = tdf7_accum_2(accum1_out_10);
      sums[11] = tdf7_accum_2(accum1_out_11);
      sums[12] = tdf7_accum_2(accum1_out_12);
      sums[13] = tdf7_accum_2(accum1_out_13);
      sums[14] = tdf7_accum_2(accum1_out_14);
      sums[15] = tdf7_accum_2(accum1_out_15);
      sums[16] = tdf7_accum_2(accum1_out_16);
      sums[17] = tdf7_accum_2(accum1_out_17);
      sums[18] = tdf7_accum_2(accum1_out_18);
      sums[19] = tdf7_accum_2(accum1_out_19);
      sums[20] = tdf7_accum_2(accum1_out_20);
      sums[21] = tdf7_accum_2(accum1_out_21);
      sums[22] = tdf7_accum_2(accum1_out_22);
      sums[23] = tdf7_accum_2(accum1_out_23);
      sums[24] = tdf7_accum_2(accum1_out_24);
      sums[25] = tdf7_accum_2(accum1_out_25);
      sums[26] = tdf7_accum_2(accum1_out_26);
      sums[27] = tdf7_accum_2(accum1_out_27);
      sums[28] = tdf7_accum_2(accum1_out_28);
      sums[29] = tdf7_accum_2(accum1_out_29);
      sums[30] = tdf7_accum_2(accum1_out_30);
      sums[31] = tdf7_accum_2(accum1_out_31);
      sums[32] = tdf7_accum_2(accum1_out_32);
      sums[33] = tdf7_accum_2(accum1_out_33);
      sums[34] = tdf7_accum_2(accum1_out_34);
      sums[35] = tdf7_accum_2(accum1_out_35);
      sums[36] = tdf7_accum_2(accum1_out_36);
      sums[37] = tdf7_accum_2(accum1_out_37);
      sums[38] = tdf7_accum_2(accum1_out_38);
      sums[39] = tdf7_accum_2(accum1_out_39);
      sums[40] = tdf7_accum_2(accum1_out_40);
      sums[41] = tdf7_accum_2(accum1_out_41);
      sums[42] = tdf7_accum_2(accum1_out_42);
      sums[43] = tdf7_accum_2(accum1_out_43);
      sums[44] = tdf7_accum_2(accum1_out_44);
      sums[45] = tdf7_accum_2(accum1_out_45);
      sums[46] = tdf7_accum_2(accum1_out_46);
      sums[47] = tdf7_accum_2(accum1_out_47);
      sums[48] = tdf7_accum_2(accum1_out_48);
      sums[49] = tdf7_accum_2(accum1_out_49);
      sums[50] = tdf7_accum_2(accum1_out_50);
      sums[51] = tdf7_accum_2(accum1_out_51);
      sums[52] = tdf7_accum_2(accum1_out_52);
      sums[53] = tdf7_accum_2(accum1_out_53);
      sums[54] = tdf7_accum_2(accum1_out_54);
      sums[55] = tdf7_accum_2(accum1_out_55);
      sums[56] = tdf7_accum_2(accum1_out_56);
      sums[57] = tdf7_accum_2(accum1_out_57);
      sums[58] = tdf7_accum_2(accum1_out_58);
      sums[59] = tdf7_accum_2(accum1_out_59);
      sums[60] = tdf7_accum_2(accum1_out_60);
      sums[61] = tdf7_accum_2(accum1_out_61);
      sums[62] = tdf7_accum_2(accum1_out_62);
      sums[63] = tdf7_accum_2(accum1_out_63);
      ...
      #pragma HLS array_partition variable=l2_products cyclic factor=16 dim=2
      ...
      #pragma HLS array_partition variable=l2_partial_sums cyclic factor=16
