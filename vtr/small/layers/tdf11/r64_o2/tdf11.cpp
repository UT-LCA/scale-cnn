...
// It reduces 576 inputs to 5 outputs.
// The estimated latency is 27 cycles.
void tdf11_accum_1(
   data_t accum_in[576], 
   data_t accum_out[5]
) {
   ...
   IL_LOOP: for (uint16_t i1 = 0; i1 < 5; i1++) {
      ...
      WRPC_LOOP: for (uint16_t w = 0; w < 128; w++) {
         // Need this bounds check because input length is not necessarily
         // a multiple of words read per cycle.
         vals[w] = (i+w < 576) ? accum_in[i+w] : (data_t)0;
      }
      data_t sum0 = vals[127] + vals[126];
      data_t sum1 = vals[125] + vals[124];
      data_t sum2 = vals[123] + vals[122];
      data_t sum3 = vals[121] + vals[120];
      data_t sum4 = vals[119] + vals[118];
      data_t sum5 = vals[117] + vals[116];
      data_t sum6 = vals[115] + vals[114];
      data_t sum7 = vals[113] + vals[112];
      data_t sum8 = vals[111] + vals[110];
      data_t sum9 = vals[109] + vals[108];
      data_t sum10 = vals[107] + vals[106];
      data_t sum11 = vals[105] + vals[104];
      data_t sum12 = vals[103] + vals[102];
      data_t sum13 = vals[101] + vals[100];
      data_t sum14 = vals[99] + vals[98];
      data_t sum15 = vals[97] + vals[96];
      data_t sum16 = vals[95] + vals[94];
      data_t sum17 = vals[93] + vals[92];
      data_t sum18 = vals[91] + vals[90];
      data_t sum19 = vals[89] + vals[88];
      data_t sum20 = vals[87] + vals[86];
      data_t sum21 = vals[85] + vals[84];
      data_t sum22 = vals[83] + vals[82];
      data_t sum23 = vals[81] + vals[80];
      data_t sum24 = vals[79] + vals[78];
      data_t sum25 = vals[77] + vals[76];
      data_t sum26 = vals[75] + vals[74];
      data_t sum27 = vals[73] + vals[72];
      data_t sum28 = vals[71] + vals[70];
      data_t sum29 = vals[69] + vals[68];
      data_t sum30 = vals[67] + vals[66];
      data_t sum31 = vals[65] + vals[64];
      data_t sum32 = vals[63] + vals[62];
      data_t sum33 = vals[61] + vals[60];
      data_t sum34 = vals[59] + vals[58];
      data_t sum35 = vals[57] + vals[56];
      data_t sum36 = vals[55] + vals[54];
      data_t sum37 = vals[53] + vals[52];
      data_t sum38 = vals[51] + vals[50];
      data_t sum39 = vals[49] + vals[48];
      data_t sum40 = vals[47] + vals[46];
      data_t sum41 = vals[45] + vals[44];
      data_t sum42 = vals[43] + vals[42];
      data_t sum43 = vals[41] + vals[40];
      data_t sum44 = vals[39] + vals[38];
      data_t sum45 = vals[37] + vals[36];
      data_t sum46 = vals[35] + vals[34];
      data_t sum47 = vals[33] + vals[32];
      data_t sum48 = vals[31] + vals[30];
      data_t sum49 = vals[29] + vals[28];
      data_t sum50 = vals[27] + vals[26];
      data_t sum51 = vals[25] + vals[24];
      data_t sum52 = vals[23] + vals[22];
      data_t sum53 = vals[21] + vals[20];
      data_t sum54 = vals[19] + vals[18];
      data_t sum55 = vals[17] + vals[16];
      data_t sum56 = vals[15] + vals[14];
      data_t sum57 = vals[13] + vals[12];
      data_t sum58 = vals[11] + vals[10];
      data_t sum59 = vals[9] + vals[8];
      data_t sum60 = vals[7] + vals[6];
      data_t sum61 = vals[5] + vals[4];
      data_t sum62 = vals[3] + vals[2];
      data_t sum63 = vals[1] + vals[0];
      data_t sum64 = sum0 + sum1;
      data_t sum65 = sum2 + sum3;
      data_t sum66 = sum4 + sum5;
      data_t sum67 = sum6 + sum7;
      data_t sum68 = sum8 + sum9;
      data_t sum69 = sum10 + sum11;
      data_t sum70 = sum12 + sum13;
      data_t sum71 = sum14 + sum15;
      data_t sum72 = sum16 + sum17;
      data_t sum73 = sum18 + sum19;
      data_t sum74 = sum20 + sum21;
      data_t sum75 = sum22 + sum23;
      data_t sum76 = sum24 + sum25;
      data_t sum77 = sum26 + sum27;
      data_t sum78 = sum28 + sum29;
      data_t sum79 = sum30 + sum31;
      data_t sum80 = sum32 + sum33;
      data_t sum81 = sum34 + sum35;
      data_t sum82 = sum36 + sum37;
      data_t sum83 = sum38 + sum39;
      data_t sum84 = sum40 + sum41;
      data_t sum85 = sum42 + sum43;
      data_t sum86 = sum44 + sum45;
      data_t sum87 = sum46 + sum47;
      data_t sum88 = sum48 + sum49;
      data_t sum89 = sum50 + sum51;
      data_t sum90 = sum52 + sum53;
      data_t sum91 = sum54 + sum55;
      data_t sum92 = sum56 + sum57;
      data_t sum93 = sum58 + sum59;
      data_t sum94 = sum60 + sum61;
      data_t sum95 = sum62 + sum63;
      data_t sum96 = sum64 + sum65;
      data_t sum97 = sum66 + sum67;
      data_t sum98 = sum68 + sum69;
      data_t sum99 = sum70 + sum71;
      data_t sum100 = sum72 + sum73;
      data_t sum101 = sum74 + sum75;
      data_t sum102 = sum76 + sum77;
      data_t sum103 = sum78 + sum79;
      data_t sum104 = sum80 + sum81;
      data_t sum105 = sum82 + sum83;
      data_t sum106 = sum84 + sum85;
      data_t sum107 = sum86 + sum87;
      data_t sum108 = sum88 + sum89;
      data_t sum109 = sum90 + sum91;
      data_t sum110 = sum92 + sum93;
      data_t sum111 = sum94 + sum95;
      data_t sum112 = sum96 + sum97;
      data_t sum113 = sum98 + sum99;
      data_t sum114 = sum100 + sum101;
      data_t sum115 = sum102 + sum103;
      data_t sum116 = sum104 + sum105;
      data_t sum117 = sum106 + sum107;
      data_t sum118 = sum108 + sum109;
      data_t sum119 = sum110 + sum111;
      data_t sum120 = sum112 + sum113;
      data_t sum121 = sum114 + sum115;
      data_t sum122 = sum116 + sum117;
      data_t sum123 = sum118 + sum119;
      data_t sum124 = sum120 + sum121;
      data_t sum125 = sum122 + sum123;
      data_t sum126 = sum124 + sum125;
      accum_out[out_idx+0] = sum126;
      out_idx += 1;
...
data_t tdf11_accum_2(data_t accum_in[5]) {
   data_t sum = 0.0;
