...
// It reduces 576 inputs to 64 outputs.
...
data_t tdf11_accum_3(data_t accum_in[8]) {
   data_t sum = 0.0;
...
void tdf11 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf11_accum_2(accum1_out_0, accum2_out_0);
      tdf11_accum_2(accum1_out_1, accum2_out_1);
      tdf11_accum_2(accum1_out_2, accum2_out_2);
      tdf11_accum_2(accum1_out_3, accum2_out_3);
      tdf11_accum_2(accum1_out_4, accum2_out_4);
      tdf11_accum_2(accum1_out_5, accum2_out_5);
      tdf11_accum_2(accum1_out_6, accum2_out_6);
      tdf11_accum_2(accum1_out_7, accum2_out_7);
      tdf11_accum_2(accum1_out_8, accum2_out_8);
      tdf11_accum_2(accum1_out_9, accum2_out_9);
      tdf11_accum_2(accum1_out_10, accum2_out_10);
      tdf11_accum_2(accum1_out_11, accum2_out_11);
      tdf11_accum_2(accum1_out_12, accum2_out_12);
      tdf11_accum_2(accum1_out_13, accum2_out_13);
      tdf11_accum_2(accum1_out_14, accum2_out_14);
      tdf11_accum_2(accum1_out_15, accum2_out_15);
      sums[0] = tdf11_accum_3(accum2_out_0);
      sums[1] = tdf11_accum_3(accum2_out_1);
      sums[2] = tdf11_accum_3(accum2_out_2);
      sums[3] = tdf11_accum_3(accum2_out_3);
      sums[4] = tdf11_accum_3(accum2_out_4);
      sums[5] = tdf11_accum_3(accum2_out_5);
      sums[6] = tdf11_accum_3(accum2_out_6);
      sums[7] = tdf11_accum_3(accum2_out_7);
      sums[8] = tdf11_accum_3(accum2_out_8);
      sums[9] = tdf11_accum_3(accum2_out_9);
      sums[10] = tdf11_accum_3(accum2_out_10);
      sums[11] = tdf11_accum_3(accum2_out_11);
      sums[12] = tdf11_accum_3(accum2_out_12);
      sums[13] = tdf11_accum_3(accum2_out_13);
      sums[14] = tdf11_accum_3(accum2_out_14);
      sums[15] = tdf11_accum_3(accum2_out_15);
