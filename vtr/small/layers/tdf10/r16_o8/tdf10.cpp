...
data_t tdf10_accum_3(data_t accum_in[16]) {
   data_t sum = 0.0;
...
void tdf10 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      data_t accum1_out_0[128];
      data_t accum1_out_1[128];
      data_t accum1_out_2[128];
      data_t accum1_out_3[128];
      data_t accum1_out_4[128];
      data_t accum1_out_5[128];
      data_t accum1_out_6[128];
      data_t accum1_out_7[128];
