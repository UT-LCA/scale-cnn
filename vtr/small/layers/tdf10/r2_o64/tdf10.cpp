...
void tdf10_l2_accum (
   ...
   L2_ACC_1: for (uint16_t group = 0; group < OUTPUT_CHANS/64; group++) {
...
data_t tdf10_accum_2(data_t accum_in[16]) {
   data_t sum = 0.0;
...
void tdf10 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      tdf10_accum_1(products[32], accum1_out_32);
      tdf10_accum_1(products[33], accum1_out_33);
      tdf10_accum_1(products[34], accum1_out_34);
      tdf10_accum_1(products[35], accum1_out_35);
      tdf10_accum_1(products[36], accum1_out_36);
      tdf10_accum_1(products[37], accum1_out_37);
      tdf10_accum_1(products[38], accum1_out_38);
      tdf10_accum_1(products[39], accum1_out_39);
      tdf10_accum_1(products[40], accum1_out_40);
      tdf10_accum_1(products[41], accum1_out_41);
      tdf10_accum_1(products[42], accum1_out_42);
      tdf10_accum_1(products[43], accum1_out_43);
      tdf10_accum_1(products[44], accum1_out_44);
      tdf10_accum_1(products[45], accum1_out_45);
      tdf10_accum_1(products[46], accum1_out_46);
      tdf10_accum_1(products[47], accum1_out_47);
      tdf10_accum_1(products[48], accum1_out_48);
      tdf10_accum_1(products[49], accum1_out_49);
      tdf10_accum_1(products[50], accum1_out_50);
      tdf10_accum_1(products[51], accum1_out_51);
      tdf10_accum_1(products[52], accum1_out_52);
      tdf10_accum_1(products[53], accum1_out_53);
      tdf10_accum_1(products[54], accum1_out_54);
      tdf10_accum_1(products[55], accum1_out_55);
      tdf10_accum_1(products[56], accum1_out_56);
      tdf10_accum_1(products[57], accum1_out_57);
      tdf10_accum_1(products[58], accum1_out_58);
      tdf10_accum_1(products[59], accum1_out_59);
      tdf10_accum_1(products[60], accum1_out_60);
      tdf10_accum_1(products[61], accum1_out_61);
      tdf10_accum_1(products[62], accum1_out_62);
      tdf10_accum_1(products[63], accum1_out_63);
      ...
      sums[32] = tdf10_accum_2(accum1_out_32);
      sums[33] = tdf10_accum_2(accum1_out_33);
      sums[34] = tdf10_accum_2(accum1_out_34);
      sums[35] = tdf10_accum_2(accum1_out_35);
      sums[36] = tdf10_accum_2(accum1_out_36);
      sums[37] = tdf10_accum_2(accum1_out_37);
      sums[38] = tdf10_accum_2(accum1_out_38);
      sums[39] = tdf10_accum_2(accum1_out_39);
      sums[40] = tdf10_accum_2(accum1_out_40);
      sums[41] = tdf10_accum_2(accum1_out_41);
      sums[42] = tdf10_accum_2(accum1_out_42);
      sums[43] = tdf10_accum_2(accum1_out_43);
      sums[44] = tdf10_accum_2(accum1_out_44);
      sums[45] = tdf10_accum_2(accum1_out_45);
      sums[46] = tdf10_accum_2(accum1_out_46);
      sums[47] = tdf10_accum_2(accum1_out_47);
      sums[48] = tdf10_accum_2(accum1_out_48);
      sums[49] = tdf10_accum_2(accum1_out_49);
      sums[50] = tdf10_accum_2(accum1_out_50);
      sums[51] = tdf10_accum_2(accum1_out_51);
      sums[52] = tdf10_accum_2(accum1_out_52);
      sums[53] = tdf10_accum_2(accum1_out_53);
      sums[54] = tdf10_accum_2(accum1_out_54);
      sums[55] = tdf10_accum_2(accum1_out_55);
      sums[56] = tdf10_accum_2(accum1_out_56);
      sums[57] = tdf10_accum_2(accum1_out_57);
      sums[58] = tdf10_accum_2(accum1_out_58);
      sums[59] = tdf10_accum_2(accum1_out_59);
      sums[60] = tdf10_accum_2(accum1_out_60);
      sums[61] = tdf10_accum_2(accum1_out_61);
      sums[62] = tdf10_accum_2(accum1_out_62);
      sums[63] = tdf10_accum_2(accum1_out_63);
      ...
      #pragma HLS array_partition variable=l2_products cyclic factor=32 dim=2
      ...
      #pragma HLS array_partition variable=l2_partial_sums cyclic factor=32
