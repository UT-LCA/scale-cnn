...
open_project -reset tdf10_prj
add_files -cflags "-I .. -I $COMMON_DIR -D FAST_COMPILE=0"  "$COMMON_DIR/global_defines.h tdf10.cpp"
add_files -tb -cflags "-I .. -I $COMMON_TEST_DIR -I $COMMON_DIR" "$COMMON_TEST_DIR/tb_utils.cpp ../test/golden.cpp ../test/tb_tdf10.cpp"
set_top tdf10_top

# Set variables for the optimization directives
set top tdf10_top
set filter_top tdf10_top
set in_data in_data
...
source tdf10_impl_directives.tcl
source ../tdf10_conv_directives.tcl
