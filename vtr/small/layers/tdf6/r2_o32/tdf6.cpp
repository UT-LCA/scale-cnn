...
data_t tdf6_accum_2(data_t accum_in[16]) {
   data_t sum = 0.0;
...
void tdf6 (
   ...
   TOP_LOOP: for (int f = 0; f < TOP_LOOP_ITERATIONS; f++) {
      ...
      sums[4] = tdf6_accum_2(accum1_out_4);
      sums[5] = tdf6_accum_2(accum1_out_5);
      sums[6] = tdf6_accum_2(accum1_out_6);
      sums[7] = tdf6_accum_2(accum1_out_7);
      sums[8] = tdf6_accum_2(accum1_out_8);
      sums[9] = tdf6_accum_2(accum1_out_9);
      sums[10] = tdf6_accum_2(accum1_out_10);
      sums[11] = tdf6_accum_2(accum1_out_11);
      sums[12] = tdf6_accum_2(accum1_out_12);
      sums[13] = tdf6_accum_2(accum1_out_13);
      sums[14] = tdf6_accum_2(accum1_out_14);
      sums[15] = tdf6_accum_2(accum1_out_15);
      sums[16] = tdf6_accum_2(accum1_out_16);
      sums[17] = tdf6_accum_2(accum1_out_17);
      sums[18] = tdf6_accum_2(accum1_out_18);
      sums[19] = tdf6_accum_2(accum1_out_19);
      sums[20] = tdf6_accum_2(accum1_out_20);
      sums[21] = tdf6_accum_2(accum1_out_21);
      sums[22] = tdf6_accum_2(accum1_out_22);
      sums[23] = tdf6_accum_2(accum1_out_23);
      sums[24] = tdf6_accum_2(accum1_out_24);
      sums[25] = tdf6_accum_2(accum1_out_25);
      sums[26] = tdf6_accum_2(accum1_out_26);
      sums[27] = tdf6_accum_2(accum1_out_27);
      sums[28] = tdf6_accum_2(accum1_out_28);
      sums[29] = tdf6_accum_2(accum1_out_29);
      sums[30] = tdf6_accum_2(accum1_out_30);
      sums[31] = tdf6_accum_2(accum1_out_31);
