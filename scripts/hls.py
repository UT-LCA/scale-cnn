...
def CalcMemReadBandwidthUtil(layer_spec, total_cycles):
...
def analyze_reports(layer_spec, impl_dir):
...
def generate_layer_summary(summary_filepath, impl_results):
   ...
   with open(csv_filepath, 'w') as csv_file:
      ...
      for impl_dir, report_info in impl_results:
         latency = report_info['latency']
         cost    = report_info['cost_info']['total']
         csv_file.write(",".join([impl_dir, latency, cost]))
         csv_file.write('\n')
...
def explore_layer_implementations(layer_spec, impl_list_path)
   ...
   layer_name = layer_spec['layer_name']
   print("Exploring {} layer implementations for {}.".format(len(impl_dirs), layer_name))
   ...
   for impl_dir in impl_dirs:
      ...
      report_info = analyze_reports(layer_spec, impl_dir)
      implementation_results.append((impl_dir, report_info))
   ...
   generate_layer_summary(summary_filepath, implementation_results)
