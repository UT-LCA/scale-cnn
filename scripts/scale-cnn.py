...
if __name__ == '__main__':
   ...
   parser.add_argument('--layer_offset', type=int, default=1, help="Layer offset for network layer synthesis (1-based)")
   ...
   if mode == 'gen_layer':
      ...
      hls.synth_network_layers(spec, args.input, args)
